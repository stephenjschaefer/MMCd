...
//  phone number (for dial-up profiles), etc.
  ...
  // UInt32; 'slip' 'ppp-' 'loop' (netIFCreatorPPP, etc.)
  ...
  // UInt32; expressed in milliseconds; see NetPrefNetTimeoutEnum for special
  ...
  // UInt16; not in interface; used to set NetLib's
  //  netIFSettingInactivityTimeout setting; might not be used by NetLib.
  NetPrefRecFieldInfoLegacy(	netPrefRecFieldInactivityTimer,	  1008, \
			  netPrefFieldTypeUInt16, 0, 0, <1008:inactm>, 13)

  // UInt16; not in interface; used to set NetLib's
  //  netIFSettingEstablishmentTimeout setting; might not be used by NetLib.
...
#undef NetPrefRecFieldInfoPostamble
